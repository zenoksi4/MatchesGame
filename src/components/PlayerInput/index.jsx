...
function PlayerInput({setPlayerTook, maxTake, gameNumMatch, setGameNumMatch, setCurrentPlayer, playerTook}) {
  ...
  return (
    <form className={styles.inputWrapper} onSubmit={submitHandler}>
        ...
        <Input onChange={userInputHandler} max={maxTake} className={styles.input}/>
